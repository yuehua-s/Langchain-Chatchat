...
```shell
docker pull chatimage/chatchat:0.3.2-dev-d15fcd4-20241014

docker pull ccr.ccs.tencentyun.com/langchain-chatchat/chatchat:0.3.2-dev-d15fcd4-20241014 # 国内镜像
```
